...
class StartArgs:
    ...
    visual_remote_timeout: float = field(default=180.0)
    visual_remote_connect_timeout: float = field(default=10.0)
    visual_remote_max_retries: int = field(default=2)
    visual_remote_max_concurrency: int = field(default=64)
    visual_remote_queue_timeout: float = field(default=10.0)
    visual_max_inflight_requests: int = field(default=64)
    visual_circuit_failure_threshold: int = field(default=5)
    visual_circuit_recovery_seconds: float = field(default=30.0)
    visual_agent_timeout: float = field(default=600.0)
