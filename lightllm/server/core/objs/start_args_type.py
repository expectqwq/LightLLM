...
class StartArgs:
    ...
    visual_remote_max_concurrency: int = field(default=32)
    visual_remote_queue_timeout: float = field(default=2.0)
    visual_max_inflight_requests: int = field(default=16)
